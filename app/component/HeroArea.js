            ...
            <div className="container px-[24px] sm:px-[0] mx-auto pt-[64px] sm:pt-[72px] md:pt-[80px] lg:pt-[96px] xl:pt-[128px] 2xl:pt-[154px]">
                <div className='flex justify-between items-start sm:flex-row flex-col sm:gap-[0] gap-[40px] sm:pb-[0] pb-[25px]'>
                  <div className='flex-1'>
                        ...
                        <p className='extaithefutere text-[14px] sm:text-[15px] md:text-[16px] lg:text-[20px] xl:text-[23px] 2xl:text-[26px]'>$EXTAI - The Future is Now!Ever wondered if Elon is more than just human? Maybe he's an extraterrestrial AI! $EXTAI is not just a token - it's the first step into a new era of technology. Get in early and claim your piece of the future!</p>
                    ...
                    <div className=' sm:pl-[40px] md:pl-[70px] lg:pl-[90px] xl:pl-[120px] 2xl:pl-[151px]'>
                      <div className='backgroundndpadding pt-[11px] sm:pt-[12px] md:pt-[13px] lg:pt-[14px] xl:pt-[15px] 2xl:pt-[16px]  px-[14px] sm:px-[15px] md:px-[16px] lg:px-[20px] xl:px-[24px] 2xl:px-[32px] pb-[15px] sm:pb-[16px] md:pb-[20px] lg:pb-[24px] xl:pb-[32px] 2xl:pb-[35px]'>
                          ...
                          <div className='overflow-hidden'>
                            <div className='ratingre text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[20px] pb-[11px] sm:pb-[12px] md:pb-[13px] lg:pb-[14px] xl:pb-[15px] 2xl:pb-[17px]'>USDT Raised: <span>$4,595,727.56 / $5,105,064</span></div>
                          ...
                          <div className='donthavwallet pt-[13px] sm:pt-[14px] md:pt-[15px] lg:pt-[16px] xl:pt-[20px] 2xl:pt-[24px] pb-[12px] sm:pb-[13px] md:pb-[14px] lg:pb-[15px] xl:pb-[16px] 2xl:pb-[18px] cursor-pointer'>Don't have a wallet?</div>
