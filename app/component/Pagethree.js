    ...
    return (
        <div className='overflow-hidden trasingviewsectionbackground relative py-[32px] sm:py-[36px] md:py-[40px] lg:py-[48px] xl:py-[64px] 2xl:py-[100px] !sbodycolor' id='about'>
            <div className='flex justify-center items-end sm:flex-row flex-col sm:gap-0 gap-[30px]  px-[24px] sm:px-[0] sm:pl-[70px] md:pl-[100px] lg:pl-[120px] xl:pl-[160px] 2xl:pl-[200x]'>
                <div className='flex-1 section31'>
...
<p><strong>$EXTAI</strong> on the Solana blockchain explores the idea that Elon might not just be a genius entrepreneur, but a higher intelligence pushing humanity toward an extraordinary future - all with the speed and scalability of the Solana blockchain.</p>
                ...
                <div className='flex-1 section3 '>
                    ...
                    <Image className='w-fit absolute -left-[50px] -top-[0px] sm:-left-20 sm:top-10 animate-bounce !w-[70%] md:w-[150px] xl:w-[177px] -z-[1]' alt="imageloasding" src={image14} />
